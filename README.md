...
- **ML Fundamentals** — Linear Regression, Logistic Regression, Gradient Descent, Classification, Clustering
- **Data Preprocessing** — Feature Scaling, OneHotEncoding, Train/Test Splits, Pipelines
...
- **APIs & Apps** — OpenAI/Claude APIs, Flask, REST APIs
...
Feel free to **star** the repo, fork it for your own learning journey, or reach out if you're on a similar AI transition path!
